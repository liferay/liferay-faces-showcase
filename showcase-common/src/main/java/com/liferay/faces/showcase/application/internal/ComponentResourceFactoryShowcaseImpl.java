 ...
 * @author  Neil Griffin
 */
public class ComponentResourceFactoryShowcaseImpl extends ComponentResourceFactory {

	// Private Data Members
	private ComponentResourceFactory wrapppedComponentResourceFactory;

	public ComponentResourceFactoryShowcaseImpl(ComponentResourceFactory componentResourceFactory) {
	...
	public ComponentResource getComponentResource(UIComponent uiComponentResource) {
		...
		return new ComponentResourceShowcaseImpl(wrappedComponentResource);
	}

 ...
 */
package com.liferay.faces.test.showcase.message;
 ...
 * @author  Philip White
 */
public class MessageGeneralTester extends OutputTester {

	@Test
	public void runMessageGeneralTest() throws Exception {

		Browser browser = Browser.getInstance();
		navigateToUseCase(browser, TEST_CONTEXT_URL + "/message/general");
